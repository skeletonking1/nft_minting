...
function App() {
  ...
  return (
    ...
    <div className="content__wrapper">
      ...
      <div style={{position: 'fixed', top: 15, right: 15, zIndex: 100}}> 
        <ConnectWalletButton style={{height:30, backgroundColor: '#ffd587',  color: '#000773', fontSize: 10, fontFamily: 'PressStart2P-Regular', padding: 8, borderRadius: 0}} />
      </div>
